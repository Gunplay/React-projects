React base level components (JSX, props, state) Functional and class components. properties and components, Changes to the properties and state of objects. Rendering. React hooks. React + Redux. Reactive Router.
